...
<div class="main-header">
    ...
    <p>Tác giả: Bùi Thị Huyền Thư - Trường Tiểu học Đông An - ĐT: 0949433157</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Bùi Thị Huyền Thư - Trường Tiểu học Đông An - ĐT: 0949433157</div>", unsafe_allow_html=True)
